            ...
            <div className='Field'>
              <h1 className='Kontakt2'>Kontaktiere uns!</h1>
                ...
                <form onSubmit={handleSubmit((data) => setData(console.log(data)))}>
                    ...
                    <input className='formels' type="submit" onClick={toggleYT} />    
                </form>

                {YTtoggle?<h1 className='Kontakt3'>Vielen Dank für ihre Anfrage. Wir werden diese schnellstmöglich bearbeiten.</h1>:<div></div>}
